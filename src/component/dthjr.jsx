const clientId = "77e4fd1425b7460fab2a92271d2bb060";
const AUTH_URL = `https://accounts.spotify.com/authorize?client_id=${clientId}
    &response_type=code&redirect_uri=http://localhost:5173&
    scope=streaming%20user-read-email%20playlist-modify-public%20user-read-private
